...
"""
token-utils documentation build configuration file.
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'App for the creation, signing, and decoding of various access tokens',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'token_utils'),
                os.path.join(root_path, 'token_utils/migrations')])
